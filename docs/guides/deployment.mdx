...
```mermaid
flowchart TD
    Dev[Development<br/>Local / Lando]

    subgraph Methods["Deployment Methods"]
        direction LR
        GH[GitHub Actions<br/>CI/CD]
        Manual[Manual SSH/FTP]
        Platform[Platform<br/>Forge, Vapor]
    end
    ...
    style Dev fill:#f3f4f6,stroke:#0d9488,stroke-width:2px
    style Methods fill:#dbeafe,stroke:#0d9488,stroke-width:2px
    style GH fill:#10b981,stroke:#059669,stroke-width:2px
    style Manual fill:#f59e0b,stroke:#d97706,stroke-width:2px
    style Platform fill:#8b5cf6,stroke:#2563eb,stroke-width:2px
    style Web fill:#6366f1,stroke:#4f46e5,stroke-width:2px
    style App fill:#3b82f6,stroke:#1e40af,stroke-width:3px
    style DB fill:#ec4899,stroke:#dc2626,stroke-width:2px
    style Cache fill:#ef4444,stroke:#b91c1c,stroke-width:2px
    style Queue fill:#f59e0b,stroke:#d97706,stroke-width:2px
    style Cron fill:#10b981,stroke:#059669,stroke-width:2px
```
...
```mermaid
flowchart LR
    Trigger[Trigger<br/>Push/Manual]

    subgraph Pipeline["CI/CD Pipeline"]
        Checkout[1. Checkout Code]
        SetupPHP[2. Setup PHP]
        Deps[3. Install Dependencies]
        Build[4. Build Assets]
        Migrate[5. Run Migrations]
        Cache[6. Clear Caches]
        Restart[7. Restart Services]
    end

    Trigger --> Checkout --> SetupPHP --> Deps --> Build --> Migrate --> Cache --> Complete[✓ Deployment Complete]

    style Trigger fill:#10b981,stroke:#059669,stroke-width:2px
    style Pipeline fill:#f3f4f6,stroke:#0d9488,stroke-width:2px
    style Checkout fill:#8b5cf6,stroke:#2563eb,stroke-width:2px
    style SetupPHP fill:#8b5cf6,stroke:#2563eb,stroke-width:2px
    style Deps fill:#8b5cf6,stroke:#2563eb,stroke-width:2px
    style Build fill:#f59e0b,stroke:#d97706,stroke-width:2px
    style Migrate fill:#ec4899,stroke:#dc2626,stroke-width:2px
    style Cache fill:#ef4444,stroke:#b91c1c,stroke-width:2px
    style Restart fill:#f59e0b,stroke:#d97706,stroke-width:2px
    style Complete fill:#059669,stroke:#03c9a6,stroke-width:3px,color:#ffffff
```
