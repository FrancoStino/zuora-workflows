...
- [Report an issue](https://github.com/FrancoStino/zuora-workflows/issues)
- [Discussions](https://github.com/FrancoStino/zuora-workflows/discussions)

## Support

For support and questions:
- Open a [GitHub issue](https://github.com/FrancoStino/zuora-workflows/issues)
- Join the [Discussions](https://github.com/FrancoStino/zuora-workflows/discussions)
- Check the [Troubleshooting guide](/developer/troubleshooting)

## License

This project is released under the MIT license. See the [LICENSE](https://github.com/FrancoStino/zuora-workflows/blob/develop/LICENSE) file for details.
