...
| Property | Value |
|-----------|--------|
| **Field** | `oauth_google_client_secret` |
...
'google' => [
    ...
    'client_secret' => env('OAUTH_GOOGLE_CLIENT_SECRET')
        ?? app(GeneralSettings::class)->oauth_google_client_secret,
...
$allowedDomains = $settings->oauth_allowed_domains;
...
{
    public string $site_name = 'Zuora Workflow Manager';
...
class GeneralSettings extends Settings
{
    ...
    public array $oauth_allowed_domains;
    public string|null $oauth_google_client_id;
    public string|null $oauth_google_client_secret;
    public string|null $admin_email;
    ...
    public function isEmailDomainAllowed(string $email): bool
    {
        ...
        return in_array($domain, $this->oauth_allowed_domains);
    }
}
```
...
class MyService
{
    ...
    {
        $enabled = $this->settings->oauth_enabled;
    }
}
```
