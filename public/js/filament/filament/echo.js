( () => {
	...
	var xi = Object.getPrototypeOf, Oi = Object.prototype.hasOwnProperty;
	var Ai = ( l, h ) => () => ( h || l( ( h = { exports: {} } ).exports, h ), h.exports );
	var Ei = ( l, h, a, c ) => {
		if ( h && typeof h == "object" || typeof h == "function" ) for ( let s of Pi( h ) ) !Oi.call( l, s ) && s !== a && he( l, s, {
			get:        () => h[ s ],
			enumerable: !( c = Ti( h, s ) ) || c.enumerable
		} );
		return l
	};
	var Li = ( l, h, a ) => ( a = l != null ? Ci( xi( l ) ) : {}, Ei( h || !l || !l.__esModule ? he( a, "default", {
		value:      l,
		enumerable: !0
	} ) : a, l ) );
	var me = Ai( ( vt, It ) => {
		( function ( h, a ) {
			...
			return ( function ( l ) {
				...
				return a.m = l, a.c = h, a.d = function ( c, s, f ) {
					a.o( c, s ) || Object.defineProperty( c, s, {
						enumerable: !0,
						get:        f
					} )
				}, a.r = function ( c ) {
				...
				for ( var nt = String.fromCharCode, Z = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Te = {}, ct = 0, Pe = Z.length ; ct < Pe ; ct++ ) Te[ Z.charAt( ct ) ] = ct;
				var xe    = function ( e ) {
				...
				var Q         = ( function ( e ) {
					...
					function t( n, r ) {
						return e.call( this, setTimeout, Re, n, function ( i ) {
							return r(), null
						} ) || this
					}
					...
					function t( n, r ) {
						return e.call( this, setInterval, Ie, n, function ( i ) {
							return r(), i
						} ) || this
					}
				...
				function qe() {
					for ( var e = [ "Pusher" ], t = 0 ; t < arguments.length ; t++ ) typeof arguments[ t ] == "string" ? e.push( arguments[ t ] ) : e.push( ut( arguments[ t ] ) );
					return e.join( " : " )
				}
				...
				var Xe    = ( function () {
					...
					return e.prototype.debug = function () {
						...
						if ( Pt.log ) Pt.log( i ); else if ( Pt.logToConsole ) {
							var o = t.bind( this );
							o( i )
						}
					}, e
					...
					return e.prototype.send = function ( t ) {
						if ( !this.request ) {
							var n = Fe( this.data ), r = this.url + "/" + t.number + "?" + n;
				...
				}, fn        = new tt( U( {}, Bt, Jt ) ), pn = new tt( U( {}, Xt, Jt ) ), dn = {
					ws:            ln,
					xhr_streaming: fn,
					xhr_polling:   pn
				}, ht        = dn, vn = new tt( {
				...
				var _n        = ht, bn = ( function () {
					...
					return t.prototype.handlesActivityChecks = function () {
						...
						i && this.emit( "error", i ), r && this.emit( r, {
							action: r,
							error:  i
						} )
					}, t
				...
				var or    = ( function () {
					...
					return e.prototype.isSupported = function () {
						...
						var r = this.usingTLS, i = ar( r ), o = [ this.strategy ];
						...
						var p = j.now(), _ = o.pop().connect( t, function g( k, E ) {
							k ? ( Qt( r ), o.length > 0 ? ( p = j.now(), _ = o.pop().connect( t, g ) ) : n( k ) ) : ( cr( r, E.transport.name, j.now() - p ), n( null, E ) )
						} );
						return {
							abort:            function () {
								_.abort()
...
` );
				...
				var $ = Ct, kr = 1, Sr = ( function () {
					...
					return e.prototype.send = function ( t ) {
						...
						if ( this.readyState === $.OPEN ) try {
							return m.createSocketRequest( "POST", Kt( Tr( this.location, this.session ) ) ).start( t ), !0
						} catch {
							return !1
						} else return !1
						...
						this.readyState === $.CONNECTING ? ( t && t.hostname && ( this.location.base = Pr( this.location.base, t.hostname ) ), this.readyState = $.OPEN, this.onopen && this.onopen() ) : this.onClose( 1006, "Server lost session", !0 )
				...
				var Fr = m.Transports, Br = function ( e, t, n, r, i, o ) {
					var u = Fr[ n ];
					if ( !u ) throw new F( n );
					var p = ( !e.enabledTransports || qt( e.enabledTransports, t ) !== -1 ) && ( !e.disabledTransports || qt( e.disabledTransports, t ) === -1 ),
						_;
					return p ? ( i = Object.assign( { ignoreNullOrigin: e.ignoreNullOrigin }, i ), _ = new zr( t, r, o ? o.getAssistant( u ) : u, i ) ) : _ = Xr, _
				}, Xr  = {
					isSupported: function () {
						return !1
					},
				...
				function ii( e, t ) {
					...
					}, "auth" in e && ( "params" in e.auth && ( n.params = e.auth.params ), "headers" in e.auth && ( n.headers = e.auth.headers ) ), "authorizer" in e && ( n.customHandler = Yr( t, n, e.authorizer ) ) ), n
				}
				...
				var hi       = ui, li = ( function () {
					...
					function t( n ) {
						...
						} ), r.watchlist = new ci( n ), r.pusher.connection.bind( "message", function ( i ) {
							var o = i.event;
					...
					return t.prototype.signin = function () {
						...
						this.serverToUserChannel = new bt( "#server-to-user-" + this.user_data.id, this.pusher ), this.serverToUserChannel.bind_global( function ( i, o ) {
						...
						if ( this.signin_requested && !( this.signinDonePromise && !this.signinDonePromise.done ) ) {
							var n  = hi(), r = n.promise, i = n.resolve, o = n.reject;
							r.done = !1;
							var u  = function () {
								r.done = !0
							};
					...
					function e( t, n ) {
						...
						"disableStats" in n && A.warn( "The disableStats option is deprecated in favor of enableStats" ), this.key = t, this.config = $r( n, this ), this.channels = G.createChannels(), this.global_emitter = new V, this.sessionID = m.randomInt( 1e9 ), this.timeline = new Hr( this.key, this.sessionID, {
						...
						this.connection = G.createConnectionManager( this.key, {
							...
							A.warn( u )
						} ), e.instances.push( this ), this.timeline.info( { instances: e.instances.length } ), this.user = new pi( this ), e.isReady && this.connect()
					}
	...
	function st( l ) {
		...
		return st = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function ( h ) {
			return typeof h
		} : function ( h ) {
	...
	function at() {
		return at = Object.assign || function ( l ) {
	...
	function D( l, h ) {
		...
		} ), Object.defineProperty( l, "prototype", { writable: !1 } ), h && At( l, h )
	}
	...
	function At( l, h ) {
		return At = Object.setPrototypeOf || function ( c, s ) {
	...
	var Lt             = ( function ( l ) {
		...
		return R( a, [ {
			...
			key:   "channel",
			value: function ( s ) {
				return this.channels[ s ] || ( this.channels[ s ] = new Lt( this.pusher, s, this.options ) ), this.channels[ s ]
			}
		}, {
			key:   "privateChannel",
			value: function ( s ) {
				return this.channels[ "private-" + s ] || ( this.channels[ "private-" + s ] = new ve( this.pusher, "private-" + s, this.options ) ), this.channels[ "private-" + s ]
			}
		}, {
			key:   "encryptedPrivateChannel",
			value: function ( s ) {
				return this.channels[ "private-encrypted-" + s ] || ( this.channels[ "private-encrypted-" + s ] = new qi( this.pusher, "private-encrypted-" + s, this.options ) ), this.channels[ "private-encrypted-" + s ]
			}
		}, {
			key:   "presenceChannel",
			value: function ( s ) {
				return this.channels[ "presence-" + s ] || ( this.channels[ "presence-" + s ] = new Ui( this.pusher, "presence-" + s, this.options ) ), this.channels[ "presence-" + s ]
			}
		}, {
			key:   "leave",
			value: function ( s ) {
		...
		return R( a, [ {
			...
			key:   "channel",
			value: function ( s ) {
				return this.channels[ s ] || ( this.channels[ s ] = new ye( this.socket, s, this.options ) ), this.channels[ s ]
			}
		}, {
			key:   "privateChannel",
			value: function ( s ) {
				return this.channels[ "private-" + s ] || ( this.channels[ "private-" + s ] = new ge( this.socket, "private-" + s, this.options ) ), this.channels[ "private-" + s ]
			}
		}, {
			key:   "presenceChannel",
			value: function ( s ) {
				return this.channels[ "presence-" + s ] || ( this.channels[ "presence-" + s ] = new Di( this.socket, "presence-" + s, this.options ) ), this.channels[ "presence-" + s ]
			}
		}, {
			key:   "leave",
			value: function ( s ) {
		...
		return R( l, [ {
			...
			key:   "connect",
			value: function () {
				if ( this.options.broadcaster == "reverb" ) this.connector = new fe( at( at( {}, this.options ), { cluster: "" } ) ); else if ( this.options.broadcaster == "pusher" ) this.connector = new fe( this.options ); else if ( this.options.broadcaster == "socket.io" ) this.connector = new pe( this.options ); else if ( this.options.broadcaster == "null" ) this.connector = new zi( this.options ); else if ( typeof this.options.broadcaster == "function" && Ni( this.options.broadcaster ) ) this.connector = new this.options.broadcaster( this.options ); else throw new Error( "Broadcaster ".concat( st( this.options.broadcaster ), " " ).concat( this.options.broadcaster, " is not supported." ) )
			}
		}, {
			key:   "disconnect",
			value: function () {
			...
			value: function ( a ) {
				if ( this.connector instanceof pe ) throw new Error( "Broadcaster ".concat( st( this.options.broadcaster ), " " ).concat( this.options.broadcaster, " does not support encrypted private channels." ) );
			...
			value: function () {
				typeof Vue == "function" && Vue.http && this.registerVueRequestInterceptor(), typeof axios == "function" && this.registerAxiosRequestInterceptor(), typeof jQuery == "function" && this.registerjQueryAjaxSetup(), ( typeof Turbo > "u" ? "undefined" : st( Turbo ) ) === "object" && this.registerTurboRequestInterceptor()
			}
		}, {
